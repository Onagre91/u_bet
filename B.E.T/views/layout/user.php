	...
	<div class="navbar navbar-inverse navbar-fixed-top bg-primary">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href=<?php echo WEBROOT. "user/_home"?>>Game Bet</a>
			</div>
			<div class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href=<?php echo WEBROOT . "user/market"?>>Place du marché</a></li>
...
<script src=<?php echo WEBROOT. "assets/JS/bet.js"?>></script>
<script src=<?php echo WEBROOT. "assets/JS/market.js"?>></script>
</html>